...
import { createI18n, useI18n as _useI18n, UseI18nOptions } from 'vue-i18n';
...
export function useI18n(options?: UseI18nOptions): ReturnType<
  typeof _useI18n
> & {
  td: (key: string, defualtValue?: string) => string;
} {
...
export default createI18n({
  legacy: false,
  locale: import.meta.env.VUE_APP_I18N_LOCALE || locale || 'zh',
